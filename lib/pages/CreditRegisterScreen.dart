...
void main() {
  runApp(new CreditRegisterScreen());
}

class CreditRegisterScreen extends StatefulWidget {
  @override
  _CreditRegisterScreenState createState() => new _CreditRegisterScreenState();
}

class _CreditRegisterScreenState extends State<CreditRegisterScreen> {
  Token? _paymentToken;
      ...
      home: new Scaffold(
        ...
        body: ListView(
          ...
          children: <Widget>[
            ...
            Divider(),
            RaisedButton(
              child: Text("あCreate Payment Method with Card"),
              onPressed: () {
